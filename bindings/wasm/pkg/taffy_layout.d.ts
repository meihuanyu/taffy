...
export interface InitOutput {
  ...
  readonly node_childCount: (a: number) => number;
  readonly node_computeLayout: (a: number, b: number) => number;
  readonly node_getDisplay: (a: number, b: number) => void;
  readonly node_setDisplay: (a: number, b: number, c: number) => void;
  readonly node_getPosition: (a: number, b: number) => void;
  readonly node_setPosition: (a: number, b: number, c: number) => void;
  readonly node_getOverflowX: (a: number, b: number) => void;
  readonly node_setOverflowX: (a: number, b: number, c: number) => void;
  readonly node_getOverflowY: (a: number, b: number) => void;
  readonly node_setOverflowY: (a: number, b: number, c: number) => void;
  readonly node_setOverflow: (a: number, b: number, c: number) => void;
  readonly node_setScrollbarWidth: (a: number, b: number, c: number) => void;
  readonly node_setInsetTop: (a: number, b: number, c: number, d: number) => void;
  readonly node_setInsetBottom: (a: number, b: number, c: number, d: number) => void;
  readonly node_setInsetLeft: (a: number, b: number, c: number, d: number) => void;
  readonly node_setInsetRight: (a: number, b: number, c: number, d: number) => void;
  readonly node_setInsetHorizontal: (a: number, b: number, c: number, d: number) => void;
  readonly node_setInsetVertical: (a: number, b: number, c: number, d: number) => void;
  readonly node_setInsetAll: (a: number, b: number, c: number, d: number) => void;
  readonly node_setWidth: (a: number, b: number, c: number, d: number) => void;
  readonly node_setHeight: (a: number, b: number, c: number, d: number) => void;
  readonly node_setMinWidth: (a: number, b: number, c: number, d: number) => void;
  readonly node_setMinHeight: (a: number, b: number, c: number, d: number) => void;
  readonly node_setMaxWidth: (a: number, b: number, c: number, d: number) => void;
  readonly node_setMaxHeight: (a: number, b: number, c: number, d: number) => void;
  readonly node_setAspectRatio: (a: number, b: number, c: number, d: number) => void;
  readonly node_setPaddingTop: (a: number, b: number, c: number, d: number) => void;
  readonly node_setPaddingBottom: (a: number, b: number, c: number, d: number) => void;
  readonly node_setPaddingLeft: (a: number, b: number, c: number, d: number) => void;
  readonly node_setPaddingRight: (a: number, b: number, c: number, d: number) => void;
  readonly node_setPaddingHorizontal: (a: number, b: number, c: number, d: number) => void;
  readonly node_setPaddingVertical: (a: number, b: number, c: number, d: number) => void;
  readonly node_setPaddingAll: (a: number, b: number, c: number, d: number) => void;
  readonly node_setMarginTop: (a: number, b: number, c: number, d: number) => void;
  readonly node_setMarginBottom: (a: number, b: number, c: number, d: number) => void;
  readonly node_setMarginLeft: (a: number, b: number, c: number, d: number) => void;
  readonly node_setMarginRight: (a: number, b: number, c: number, d: number) => void;
  readonly node_setMarginHorizontal: (a: number, b: number, c: number, d: number) => void;
  readonly node_setMarginVertical: (a: number, b: number, c: number, d: number) => void;
  readonly node_setMarginAll: (a: number, b: number, c: number, d: number) => void;
  readonly node_setBorderWidthTop: (a: number, b: number, c: number, d: number) => void;
  readonly node_setBorderWidthBottom: (a: number, b: number, c: number, d: number) => void;
  readonly node_setBorderWidthLeft: (a: number, b: number, c: number, d: number) => void;
  readonly node_setBorderWidthRight: (a: number, b: number, c: number, d: number) => void;
  readonly node_setBorderWidthHorizontal: (a: number, b: number, c: number, d: number) => void;
  readonly node_setBorderWidthVertical: (a: number, b: number, c: number, d: number) => void;
  readonly node_setBorderWidthAll: (a: number, b: number, c: number, d: number) => void;
  readonly node_setRowGap: (a: number, b: number, c: number, d: number) => void;
  readonly node_setColumnGap: (a: number, b: number, c: number, d: number) => void;
  readonly node_setGap: (a: number, b: number, c: number, d: number) => void;
  readonly node_setAlignContent: (a: number, b: number, c: number) => void;
  readonly node_setJustifyContent: (a: number, b: number, c: number) => void;
  readonly node_setAlignItems: (a: number, b: number, c: number) => void;
  readonly node_setJustifyItems: (a: number, b: number, c: number) => void;
  readonly node_setAlignSelf: (a: number, b: number, c: number) => void;
  readonly node_setJustifySelf: (a: number, b: number, c: number) => void;
  readonly node_setFlexDirection: (a: number, b: number, c: number) => void;
  readonly node_setFlexWrap: (a: number, b: number, c: number) => void;
  readonly node_setFlexGrow: (a: number, b: number, c: number) => void;
  readonly node_setFlexShrink: (a: number, b: number, c: number) => void;
  readonly node_setFlexBasis: (a: number, b: number, c: number, d: number) => void;
  readonly node_setGridAutoFlow: (a: number, b: number, c: number) => void;
